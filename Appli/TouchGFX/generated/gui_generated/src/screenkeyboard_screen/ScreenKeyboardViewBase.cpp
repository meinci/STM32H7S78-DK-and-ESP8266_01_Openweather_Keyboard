    ...
    buttonCallback(this, &ScreenKeyboardViewBase::buttonCallbackHandler)
{
    ...
    buttonOK.setLabelText(touchgfx::TypedText(T___SINGLEUSE_EJUD));
    ...
    buttonCancel.setLabelText(touchgfx::TypedText(T___SINGLEUSE_9KEY));
...
void ScreenKeyboardViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    {
        //ButtonCancel
        //When buttonCancel clicked change screen to ScreenConnectSSID
        //Go to ScreenConnectSSID with no screen transition
        application().gotoScreenConnectSSIDScreenNoTransition();
    }
    if (&src == &buttonOK)
    {
        //ButtonOK
        ...
        //changeToScreenConnectSSID
        //When ButtonOK completed change screen to ScreenConnectSSID
        //Go to ScreenConnectSSID with no screen transition
        application().gotoScreenConnectSSIDScreenNoTransition();
    }
}
